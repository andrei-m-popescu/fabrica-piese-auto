...
{
    public partial class FormaAfisareDBLot : Form
    {
    ...
    "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=FabricaPieseAutoDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        public FormaAfisareDBLot()
        {
            InitializeComponent();
        }

        private void FormaAfisareDBLot_Load(object sender, EventArgs e)
        {
            connection.Open();
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Loturi", connection);
